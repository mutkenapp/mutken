...
const dict: Record<string, { ar: string; en: string }> = {
  ...
  "hero.msg.math": {
    ar: "لاحظت أنك أتقنت الجمع والطرح بنسبة ٩٢٪. اليوم سننهي الكسور معًا خطوة بخطوة.",
    en: "I noticed you mastered addition & subtraction with 92%. Today we'll finish fractions together, step by step.",
  },
  "hero.msg.science": {
    ar: "أداؤك في القوى ممتاز! اليوم سنكمل تجربة الحركة خطوة بخطوة.",
    en: "Your work on forces is excellent! Today we'll complete the motion experiment together.",
  },
  "hero.msg.english": {
    ar: "قواعدك تتحسن بسرعة! اليوم نتدرب على المحادثة معًا.",
    en: "Your grammar is improving fast! Today we practice speaking together.",
  },
  "hero.msg.arabic": {
    ar: "إعرابك أصبح دقيقًا! اليوم نكمل درس الإعراب معًا.",
    en: "Your I'raab is getting sharp! Today we'll finish the lesson together.",
  },
  ...
  "today.goalTitle": {
    ar: "أكمل خطة الكسور في الرياضيات",
    en: "Complete your Math Fractions Plan",
  },
  ...
  "today.msg": {
    ar: "اليوم سنركز على ضرب الكسور…",
    en: "Today we'll focus on multiplying fractions…",
  },
  ...
  "today.meetingWhen": {
    ar: "الثلاثاء، ٦:٣٠ مساءً · مع أ. سارة",
    en: "Tue, 6:30 PM · with Ms. Sara",
  },
  ...
  "today.recTitle": {
    ar: "راجع الكسور المتكافئة قبل بدء الاختبار",
    en: "Review equivalent fractions before starting the quiz",
  },
  ...
  "sub.science.goal": {
    ar: "أكمل تجربة القوى والحركة",
    en: "Complete the Forces & Motion experiment",
  },
  ...
  "meeting.math.when": {
    ar: "الثلاثاء، ٦:٣٠ مساءً · مع أ. أحمد",
    en: "Tue, 6:30 PM · with Mr. Ahmed",
  },
  ...
  "teacher.science.msg": {
    ar: "جهّزي التجربة قبل الحصة، ستحبينها!",
    en: "Get the experiment ready before class, you'll love it!",
  },
  "meeting.science.title": { ar: "مختبر القوى والحركة", en: "Forces & Motion Lab" },
  "meeting.science.when": {
    ar: "الأربعاء، ٥:٠٠ مساءً · مع أ. منى",
    en: "Wed, 5:00 PM · with Ms. Mona",
  },
  ...
  "teacher.english.msg": {
    ar: "لنراجع الأزمنة الحاضرة بمحادثة قصيرة.",
    en: "Let's review present tenses with a short conversation.",
  },
  "meeting.english.title": { ar: "محادثة إنجليزية", en: "English Speaking Session" },
  "meeting.english.when": {
    ar: "الخميس، ٤:٠٠ مساءً · مع أ. ليلى",
    en: "Thu, 4:00 PM · with Ms. Layla",
  },
  ...
  "teacher.arabic.msg": {
    ar: "سنتدرب اليوم على الإعراب معاً.",
    en: "Today we'll practice I'raab together.",
  },
  "meeting.arabic.title": { ar: "درس الإعراب", en: "I'raab Lesson" },
  "meeting.arabic.when": {
    ar: "الاثنين، ٥:٣٠ مساءً · مع أ. خالد",
    en: "Mon, 5:30 PM · with Mr. Khaled",
  },
  ...
  "progress.saraText": {
    ar: "تتحسن جيداً في الرياضيات. هذا الأسبوع ركّز على حل المسائل وقراءة الأسئلة بعناية.",
    en: "You're improving well in Math. This week, focus on problem-solving and reading questions carefully.",
  },
  "progress.aiInsight": { ar: "توصية الذكاء الاصطناعي", en: "AI Insight" },
  "progress.aiText": {
    ar: "الطلاب مثلك تحسّنوا أسرع بثلاث جلسات تدريب قصيرة على الكسور",
    en: "Students like you improved faster with 3 short practice sessions in Fractions",
  },
  ...
  // Library
  "library.title": { ar: "راجع واختبر", en: "Review & Test" },
  "library.subtitle": {
    ar: "راجع: تصفّح جميع المواد والوحدات والدروس بنفسك.\nاختبر: أنشئ اختباراً ذاتياً وقِس جاهزيتك للامتحان المدرسي.",
    en: "Review: browse all subjects, units, and lessons yourself.\nTest: create a self test and measure readiness for the school exam.",
  },
  "library.searchPlaceholder": {
    ar: "ابحث عن دروس أو مواد أو مهارات…",
    en: "Search lessons, subjects, skills…",
  },
  ...
  "library.becauseFractions": {
    ar: "لأنك تتدرب على الكسور",
    en: "Because you're practicing Fractions",
  },
  ...
  "live.explanation": {
    ar: "أحسنت! وحّد المقامات ثم اجمع البسط.",
    en: "Great! Find a common denominator, then add the numerators.",
  },

  // Challenges
  "challenges.title": { ar: "التحديات", en: "Challenges" },
  "challenges.subtitle": {
    ar: "تنافس، تدرّب، وتحسّن كل أسبوع",
    en: "Compete, practice, and improve every week",
  },
  ...
  "challenges.sprintDesc": {
    ar: "أكمل ٢٠ سؤال كسور بدقة ٨٠٪",
    en: "Complete 20 fraction questions with 80% accuracy",
  },
  ...
  "challenges.mostImprovedText": {
    ar: "ارتفعت ١٤٪ في الرياضيات · واصل!",
    en: "You're up 14% in Math · Keep it up!",
  },
  ...
  "chat.msg1": {
    ar: "مرحباً عمر! جهزت خطة اليوم لك. ركّز على المهمة الثانية لأن اختبارك السابق أظهر أخطاء في التبسيط.",
    en: "Hi Omar! I prepared your study plan for today. Focus on Task 2 because your last quiz showed some mistakes in simplification.",
  },
  "chat.studyPlan": { ar: "خطة الدراسة", en: "Study Plan" },
  "chat.mathFractions": { ar: "رياضيات · كسور", en: "Math · Fractions" },
  "chat.msg2": {
    ar: "تحسنت من ٦٨٪ إلى ٨٢٪ الأسبوع الماضي — تقدم رائع! التالي سنتدرب على المسائل الكلامية معاً.",
    en: "You improved from 68% to 82% last week — great progress! Next, we'll practice word problems together.",
  },
  "chat.studentMsg": {
    ar: "شكراً أ. سارة! لم أفهم السؤال ٤ في التدريب.",
    en: "Thank you Ms. Sara! I don't understand question 4 in the practice.",
  },
  "chat.msg3": {
    ar: "لا مشكلة. حوّل العدد المختلط إلى كسر غير حقيقي أولاً، ثم اضرب. شاهد هذا المقطع لـ ٣٠ ثانية:",
    en: "No problem. Try converting the mixed number to an improper fraction first, then multiply. Watch this 30-second clip:",
  },
  ...
  "plan.noteText": {
    ar: "ركّز على فهم الطريقة، ليس فقط الحل السريع. إذا حصلت على أقل من ٧٠٪ ستتضمن الخطة القادمة نشاط مراجعة.",
    en: "Focus on understanding the method, not just solving fast. If you score below 70%, the next plan will include a review activity.",
  },
  ...
  "plan.obj3": {
    ar: "حل المسائل الكلامية باستخدام الكسور",
    en: "Solve word problems using fractions",
  },
  ...
  "plan.aiTipText": {
    ar: "راجع الكسور المتكافئة قبل الاختبار لرفع الدقة.",
    en: "Review equivalent fractions before the quiz to boost accuracy.",
  },
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const stored = (typeof window !== "undefined" &&
      localStorage.getItem("mutken-lang")) as Lang | null;
